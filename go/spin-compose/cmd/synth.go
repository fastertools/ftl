...
The synth command takes your spin-compose configuration and generates a complete
Spin application manifest that can be used with 'spin up' or 'spin deploy'.`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		return runSynth(inputFile, outputFile, environment, setVars)
	},
}
...
func runSynth(inputFile, outputFile, environment string, setVars []string) error {
