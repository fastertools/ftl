	...
	return []Construct{
		{
			...
			Examples: []string{
				"spin-compose init ai-assistant --template mcp",
				"spin-compose init tool-platform --template mcp",
			},
		},
		{
			Name:        "wordpress",
			...
			Examples: []string{
				"spin-compose init my-blog --template wordpress",
			},
		},
		{
			Name:        "microservices",
			...
			Examples: []string{
				"spin-compose init api-platform --template microservices",
			},
		},
		{
			Name:        "ai-pipeline",
			...
			Examples: []string{
				"spin-compose init ml-platform --template ai-pipeline",
			},
		},
	}
}
