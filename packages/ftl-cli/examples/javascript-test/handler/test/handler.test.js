...
describe('Handler', () => {
    describe('listTools', () => {
        it('should return tool metadata', () => {
            ...
            expect(tools[0].name).toBe('javascript_test');
            expect(tools[0].description).toBe('An MCP tool written in JavaScript');
        });
    });
    ...
    describe('callTool', () => {
        it('should process input correctly', () => {
            ...
            const result = Handler.callTool('javascript_test', args);
        ...
        it('should handle invalid JSON', () => {
            const result = Handler.callTool('javascript_test', 'invalid json');
