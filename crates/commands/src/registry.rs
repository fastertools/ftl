...
mod tests {
    ...
    fn test_ghcr_adapter() {
        ...
        assert_eq!(custom_adapter.get_registry_url("my-tool"), "ghcr.io/myorg/my-tool");
    }
    ...
    async fn test_custom_registry_with_port() {
        let adapter = CustomAdapter::new("https://registry.company.com:5000/v2/{image_name}".to_string());
        let client = reqwest::Client::new();
