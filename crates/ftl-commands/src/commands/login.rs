...
use ftl_core::deps::{AsyncRuntime, MessageStyle, StoredCredentials, UserInterface};
...
pub trait HttpClient: Send + Sync {
    /// Send a POST request with URL-encoded body
...
pub trait Clock: Send + Sync {
    ...
    /// Get the current instant for measuring durations
...
pub struct LoginDependencies {
    ...
    /// Browser launcher for opening auth URLs
...
/// Login command arguments (matches CLI parser)
#[derive(Debug, Clone)]
